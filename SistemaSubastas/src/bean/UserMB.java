...
public class UserMB
{
	...
	/**
	 * Método que inicializa la subasta desde la lista para ser modificado
	 * 
	 * @return redirección de la página
	 */
	public String prepararModificarSubasta()
	{
		logger.trace("Entra al método prepararModificarSubasta");
		sale = (Salesueb) (listaSubastas.getRowData());
		logger.info(
				"Objeto sale inicializado con la fila de la listaSubasta y nos dirige a la página /administrador/modificarSubasta");
	...
	{
		logger.trace("Entra al método ExcelSubastas");
